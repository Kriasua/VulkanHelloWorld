...
public:
	...
	static std::shared_ptr<Texture> createDepthTexture(Devices& device, uint32_t width, uint32_t height, VkImageUsageFlags usage = VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT);
private:
